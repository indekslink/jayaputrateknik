...
@section('title','Add What We Offer')
@section('content')
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item "><a href="{{route('sosmed.index')}}">What We Offer</a></div>

            <div class="breadcrumb-item">Add What We Offer</div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-8">
                        ...
                        <form action="{{route('wwe.store')}}" onsubmit="actionDisabled('.btn-save')" method="post">
                            <div class="row justify-content-center">
                                @csrf
